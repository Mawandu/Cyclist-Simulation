...
[CustomEditor(typeof(UTS_StandingPeopleStreet))]
public class UTS_StandingPeopleStreetEditor : Editor
{

    public override void OnInspectorGUI()
    {
        UTS_StandingPeopleStreet _SPC = target as UTS_StandingPeopleStreet;
