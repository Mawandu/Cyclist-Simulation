...
public class UTS_StandingPeopleConcert : MonoBehaviour {
    ...
    {
	    int[] peoplePrefabIndexes = UTS_CommonUtils.GetRandomPrefabIndexes(_peopleCount, ref peoplePrefabs);
		...
		{			
			...
			if(randomPosition != Vector3.zero)
			{
                ...
                UTS_PeopleController pc = obj.AddComponent<UTS_PeopleController>();
