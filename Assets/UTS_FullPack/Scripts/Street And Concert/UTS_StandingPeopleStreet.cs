...
public class UTS_StandingPeopleStreet : MonoBehaviour {
	...
	{	
        ...
        int[] peoplePrefabIndexes = UTS_CommonUtils.GetRandomPrefabIndexes(peopleCount, ref peoplePrefabs);
		...
		for(int i = 0; i < one; i++)
		{
			...
			if(randomPosition != Vector3.zero)
			{
                ...
                obj.AddComponent<UTS_PeopleController>();
                ...
                obj.GetComponent<UTS_PeopleController>().animNames = new string[2] { "idle1", "idle2" };
		...
		for(int i = 0; i < two / 2; i++)
		{
			...
			if(randomPosition != Vector3.zero)
			{
                ...
                if (randomPos1 != Vector3.zero && randomPos2 != Vector3.zero)
                {
                    ...
                    obj.AddComponent<UTS_PeopleController>();
                    obj.GetComponent<UTS_PeopleController>().animNames = new string[3] { "talk1", "talk2", "listen" };
                    obj.transform.parent = par.transform;
                    ...
                    obs.AddComponent<UTS_PeopleController>();
                    obs.GetComponent<UTS_PeopleController>().animNames = new string[3] { "talk1", "talk2", "listen" };
                    obs.transform.parent = par.transform;


                    obs.GetComponent<UTS_PeopleController>().SetTarget(obj.transform.position);
                    obj.GetComponent<UTS_PeopleController>().SetTarget(obs.transform.position);
                }
            }
		}
			...
			if(randomPosition != Vector3.zero)
			{
				...
				if(randomPos0 != Vector3.zero)
				{
                    if (randomPos0 != Vector3.zero)
                    {
                        ...
                        obj.GetComponent<UTS_PeopleController>().SetTarget(randomPosition);
                    ...
                    if (randomPos0 != Vector3.zero)
                    {
                        ...
                        obs.GetComponent<UTS_PeopleController>().SetTarget(randomPosition);
                    ...
                    if (randomPos0 != Vector3.zero)
                    {
                        ...
                        obl.AddComponent<UTS_PeopleController>();

                        obl.GetComponent<UTS_PeopleController>().SetTarget(randomPosition);

                        obl.GetComponent<UTS_PeopleController>().animNames = new string[3] { "talk1", "talk2", "listen" };
