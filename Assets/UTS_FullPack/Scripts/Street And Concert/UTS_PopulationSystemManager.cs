...
public class UTS_PopulationSystemManager : MonoBehaviour
{
...
#endif
		emptyObject.AddComponent<UTS_StandingPeopleConcert>();

		var _StandingPeopleConcert = emptyObject.GetComponent<UTS_StandingPeopleConcert>();
	...
	public void Street(Vector3 pos)
	{
		...
		Selection.activeGameObject = emptyObject;
#endif
		emptyObject.AddComponent<UTS_StandingPeopleStreet>();

		var _StandingPeopleStreet = emptyObject.GetComponent<UTS_StandingPeopleStreet>();
