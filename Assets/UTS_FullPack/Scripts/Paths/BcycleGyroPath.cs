...
public class BcycleGyroPath : UTS_WalkPath
{
    [Tooltip("Direction of movement / Направление движения. Левостороннее, правостороннее, итд.")] [SerializeField] private new EnumDir direction;
    ...
    public override void SpawnOnePeople(int w, bool forward)
    {
        ...
        var movePath = people.AddComponent<UTS_MovePath>();
    ...
    public override void SpawnPeople()
    {
        ...
        for (int wayIndex = 0; wayIndex < numberOfWays; wayIndex++)
        {
            ...
            int[] pickList = UTS_CommonUtils.GetRandomPrefabIndexes(peopleCount, ref walkingPrefabs);
