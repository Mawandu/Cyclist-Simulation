...
public class UTS_WalkPath : MonoBehaviour
{
    public enum EnumDir
    {
        Forward,
    ...
    [Tooltip("Direction of movement / Направление движения. Левостороннее, правостороннее, итд.")] protected EnumDir direction;
    ...
    [HideInInspector] public UTS_PathType UTS_PathType = UTS_PathType.PeoplePath;
    ...
    public void AddPoint()
    {
        ...
        var prefab = GameObject.Find("Population System").GetComponent<UTS_PopulationSystemManager>().pointPrefab;
